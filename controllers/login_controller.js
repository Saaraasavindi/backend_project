                            ...
                            if (pResult.length > 0) {
                                ...
                                if (final_total > pResult[0].min_order_amount) {
                                    ...
                                    res.json({
                                        ...
                                        'message': "Promo Code not apply need min order: LKR" + pResult[0].min_order_amount
                                    })
                                    return
                                }
                                ...
                                if (reqObj.promo_code_id != "") {
                                    if (pResult[1].length > 0) {
                                        ...
                                        if (final_total > pResult[1][0].min_order_amount) {
                                            ...
                                            res.json({
                                                'status': "0"
                                                , 'message': "Promo Code not apply need min order: LKR" + pResult[1][0].min_order_amount
                                            })
                                            return
                                        }
